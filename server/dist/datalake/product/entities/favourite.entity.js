...
__decorate([
    (0, typeorm_1.OneToOne)(() => user_entity_1.User, (user) => user.favourite),
    __metadata("design:type", user_entity_1.User)
], Favourite.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => product_entity_1.Product, (product) => product.favourites, {
        cascade: true,
        onDelete: 'CASCADE',
    }),
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Array)
], Favourite.prototype, "products", void 0);
